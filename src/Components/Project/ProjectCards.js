    ...
    return(
        <ReactCardFlip isFlipped={flipped}>
            <Card className={classes.root} key={props.card.id} variant="outlined" >
                ...
                <a href={props.card.site} className={classes.indexUp} target='_blank' alt="Site-Link">
                ...
                <div>
                    <a href={props.card.git} target='_blank' className="fa fa-github" alt="Git-Link">{null}</a>
                </div>          
            </Card>
